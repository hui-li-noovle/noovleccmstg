- dashboard: aws_summary
  ...
  - name: SERVICE AREA
    ...
    - model: cost_control_multicloud
      explore: mat_dashboard
      type: looker_grid
      fields: [mat_dashboard.service_description, mat_dashboard.net_cost_clear]
    ...
    - model: cost_control_multicloud
      explore: mat_dashboard
      type: table
      fields: [mat_dashboard.credits_clear, mat_dashboard.service_description]
      sorts: [mat_dashboard.credits_clear desc]
      filters:
        mat_dashboard.provider: "AWS"
    ...
    series_labels:
      mat_dashboard.net_cost_clear : Net Cost
      mat_dashboard.credits_clear: Credits
    ...
    conditional_formatting_include_nulls: false
    series_value_format:
      mat_dashboard.credits: '[<=1000000]€0.00,"K";€0.00,,"M"'
    type: looker_grid
    series_types: {}
    row: 37
    col: 0
  ...
  - name: SKU
    ...
    - model: cost_control_multicloud
      explore: mat_dashboard
      type: looker_grid
      fields: [mat_dashboard.net_cost_clear, mat_dashboard.sku_description]
      sorts: [mat_dashboard.net_cost_clear desc]
      filters:
        mat_dashboard.provider: "AWS"
      listen:
    ...
    - model: cost_control_multicloud
      explore: mat_dashboard
      type: table
      fields: [mat_dashboard.credits_clear, mat_dashboard.sku_description]
      sorts: [mat_dashboard.credits_clear desc]
      filters:
        mat_dashboard.provider: "AWS"
      listen:
      ...
      query_timezone: America/Los_Angeles
      join_fields:
      - field_name: mat_dashboard.sku_description
        source_field_name: mat_dashboard.sku_description
    color_application:
      collection_id: google
      palette_id: google-categorical-0
    show_sql_query_menu_options: false
